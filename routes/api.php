...
Route::middleware(['auth:sanctum', 'check-timeout'])->group(function () {
    ...
    Route::prefix('student')->group(function () {
        ...
        Route::post('/files', [StudentController::class, 'getFiles'])
                ->middleware(['check-api-permission:students.full']);   
    ...
    Route::prefix('teacher')->group(function () {
        ...
        Route::get('/get', [TeacherController::class, 'getTeacherNames']);       // Add a new teacher (Admin only)
    ...
    Route::prefix('fee_plan')->group(function () {
        ...
        Route::post('/register', [FeePlanController::class, 'createOrUpdate'])
                ->middleware(['check-api-permission:fee.full']); // Create a new record
    ...
    Route::prefix('item')->group(function () {
        ...
        Route::get('/category', [ItemController::class, 'getDistinctCategories'])
                ->middleware(['check-api-permission:inventory.full, inventory.view']);
    ...
    Route::prefix('new_admission')->group(function () {
        Route::post('/view', [NewAdmissionController::class, 'index'])
