...
class StudentDetailsModel extends Model
{
    ...
    protected $fillable = [
        'id', 'st_id', 'aadhaar_no', 'residential_address1', 'residential_address2', 'residential_address3', 'city', 'state', 'country', 'pincode', 'class_group', 'f_name', 'f_email', 'f_contact', 'f_occupation', 'f_business_name', 'f_business_nature', 'f_business_address1', 'f_business_address2', 'f_business_city', 'f_business_state', 'f_business_country', 'f_business_pincode', 'f_employer_name',
        'f_designation', 'f_work_address1', 'f_work_address2', 'f_work_city', 'f_work_state', 'f_work_country', 'f_work_pincode', 'm_name', 'm_email', 'm_contact', 'm_occupation', 'm_business_name', 'm_business_nature', 'm_business_address1', 'm_business_address2', 'm_business_city', 'm_business_state', 'm_business_country', 'm_business_pincode',
