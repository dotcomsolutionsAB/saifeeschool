...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_teacher_application', function (Blueprint $table) {
            ...
            $table->string('resume_path')->nullable(); // Resume/CV file path
            $table->string('photo_path')->nullable(); // Photograph file path
            $table->string('id_proof_path')->nullable(); // ID proof file path
            $table->string('qualification_docs_path')->nullable(); // Qualification documents file path
